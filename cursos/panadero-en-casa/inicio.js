...
const enlace_afiliado = function () {window.open("https://go.hotmart.com/C80500599K?ap=6a74")}
...
const TYPE_OF_CURRENCY = {
  ...
  "PE" : ["s/ 396.00", "s/ 198.00",    "s/ 99.00",          "SOLES",    "s/ 45.00", "s/ 45.00",  "s/ 50.00",  "s/ 45.00",   "s/ 45.00", "s/ 25.00",        "s/ 25.00",       "s/ 17.00",        "s/ 99.00"],
  ...
  "PT" : ["$100.00", "$50.00", "$25.00", "DÓLARES", "$10", "$10", "$10", "$10", "$10", "$10", "$10", "$5", "$25"],
