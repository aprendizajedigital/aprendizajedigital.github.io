...
//PERU -> ["s/ 388.00", "s/ 194.00", "s/ 97.00"] - ["s/ 394.00", "s/ 197.00", "s/ 98.50"] - ["s/ 398.00", "s/ 199.00", "s/ 99.50"] - ["s/ 410.00", "s/ 205.00", "s/ 102.50"] - ["s/ 414.00", "s/ 207.00", "s/ 103.50"] - ["s/ 420.00", "s/ 210.00", "s/ 105.00"] 
//COLOMBIA -> ["$452.470,00", "$226.235,00", "$113.117,00"] - ["$478.368,00", "$232.257,00", "$116.128,00"] - ["$478.368,00", "$239.184,00", "$119.592,00"]
const TYPE_OF_CURRENCY = {
  "PE" : ["s/ 414.00", "s/ 207.00", "s/ 103.50"],
  "CL" : ["$452.470,00", "$226.235,00", "$113.117,00"],
...
function randomUser() {
  ...
  let user62 = { name: "Chris", photo: "62.jpg", country: "Suiza" }
  let user63 = { name: "Claudia", photo: "63.jpg", country: "Suecia" }
  let user64 = { name: "Robert", photo: "64.jpg", country: "Ucrania" }
  let user65 = { name: "Jean Pierre", photo: "65.jpg", country: "Polonia" }
  let user66 = { name: "Manuel", photo: "66.jpg", country: "Qatar" }
  let user67 = { name: "Alexander", photo: "67.jpg", country: "Filipinas" }
  let user68 = { name: "Saúl", photo: "68.jpg", country: "Turquía" }
  let user69 = { name: "Alex", photo: "69.jpg", country: "Noruega" }
  let user70 = { name: "José", photo: "70.jpg", country: "Países Bajos" }
  let user71 = { name: "Renzo", photo: "71.jpg", country: "Malasia" }
  let user72 = { name: "Miguel", photo: "72.jpg", country: "Perú" }
  let user73 = { name: "Carlos", photo: "73.jpg", country: "Luxemburgo" }
  let user74 = { name: "Estefano", photo: "74.jpg", country: "Lituania" }
  let user75 = { name: "Sebastián ", photo: "75.jpg", country: "Liberia" }
  let user76 = { name: "Guillermo", photo: "76.jpg", country: "Japón" }
  let user77 = { name: "Rubén", photo: "77.jpg", country: "Jamaica" }
  let user78 = { name: "Aarón", photo: "78.jpg", country: "Italia" }
  let user79 = { name: "Jaime", photo: "79.jpg", country: "Irlanda" }
  let user80 = { name: "Iván", photo: "80.jpg", country: "Indonesia" }
  let user81 = { name: "Francisco", photo: "81.jpg", country: "Israel" }
  let user82 = { name: "Victor", photo: "82.jpg", country: "Guatemala" }
  let user83 = { name: "Rodrigo", photo: "83.jpg", country: "Islandia" }
  let user84 = { name: "Héctor", photo: "84.jpg", country: "Hungría" }
  let user85 = { name: "Darío", photo: "85.jpg", country: "China" }
  ...
  let user89 = { name: "Adam", photo: "89.jpg", country: "Grecia" }
  let user90 = { name: "Jorge", photo: "90.jpg", country: "Georgia" }
  let user91 = { name: "Gabriel", photo: "91.jpg", country: "Alemania" }
  let user92 = { name: "Dylan", photo: "92.jpg", country: "Francia" }
  let user93 = { name: "Nicolás", photo: "93.jpg", country: "Finlandia" }
  let user94 = { name: "Sergio", photo: "94.jpg", country: "Bélgica" }
  let user95 = { name: "Gael", photo: "95.jpg", country: "Perú" }
  let user96 = { name: "Juan", photo: "96.jpg", country: "Bolivia" }
  let user97 = { name: "Ángel", photo: "97.jpg", country: "Colombia" }
  let user98 = { name: "Marc", photo: "98.jpg", country: "Argentina" }
  ...
  let user117 = { name: "Mateo", photo: "117.jpg", country: "México" }
  let user118 = { name: "Lucas", photo: "118.jpg", country: "México" }
  let user119 = { name: "Martín", photo: "119.jpg", country: "Chile" }
  let user120 = { name: "Hugo", photo: "120.jpg", country: "Colombia" }
