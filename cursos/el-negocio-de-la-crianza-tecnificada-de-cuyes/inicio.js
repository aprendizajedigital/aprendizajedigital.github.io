...
//Enlace de afiliado
const enlace_afiliado = function () {window.open("https://hotm.art/oferta-por-lanzamiento-de-cuyes")} //https://hotm.art/el-negocio-de-la-crianza-tecnificada-de-cuyes
...
const TYPE_OF_CURRENCY = {
  ...
  // "PE" : ["s/ 394.00", "s/ 197.00",    "s/ 98.50",          "SOLES",    "s/ 45.00", "s/ 45.00",  "s/ 50.00",  "s/ 45.00",   "s/ 45.00", "s/ 25.00",        "s/ 25.00",       "s/ 15.50",        "s/ 98.50"],
  // "PE" : ["s/ 398.00", "s/ 199.00",    "s/ 99.50",          "SOLES",    "s/ 45.00", "s/ 45.00",  "s/ 50.00",  "s/ 45.00",   "s/ 45.00", "s/ 25.00",        "s/ 25.00",       "s/ 18.50",        "s/ 99.50"],
  "PE" : ["s/ 400.00", "s/ 200.00",    "s/ 15.00",          "SOLES",    "s/ 45.00", "s/ 45.00",  "s/ 50.00",  "s/ 45.00",   "s/ 45.00", "s/ 25.00",        "s/ 25.00",       "s/ 20.00",        "s/ 15.00"],
  // "PE" : ["s/ 394.00", "s/ 197.00",    "s/ 98.50",          "SOLES",    "s/ 45.00", "s/ 45.00",  "s/ 50.00",  "s/ 45.00",   "s/ 45.00", "s/ 25.00",        "s/ 25.00",       "s/ 15.50",        "s/ 98.50"],

  //"PE" : ["s/ 390.00", "s/ 195.00",    "s/ 97.50",          "SOLES",    "s/ 45.00", "s/ 45.00",  "s/ 50.00",  "s/ 45.00",   "s/ 40.00", "s/ 25.00",        "s/ 25.00",       "s/ 17.50",        "s/ 97.50"],
